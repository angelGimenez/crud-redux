import { Card, Title, Badge, Table, TableHead, TableBody, TableRow, TableHeaderCell, TableCell } from '@tremor/react'
import { useAppSelector } from '../hooks/useStore.ts'
import { useDispatchUsersActions } from '../hooks/useDispatchUserActions.ts'

export function ListOfUsers() {
  const users = useAppSelector(state => state.users)
  const { dispatchDeleteUserById } = useDispatchUsersActions()
